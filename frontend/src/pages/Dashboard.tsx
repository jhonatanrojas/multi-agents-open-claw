...
import { useLoadProject, useRetryPlanning, useTestModel, useUpdateModels } from '@/api';
...
export function Dashboard() {
  ...
  // =====================
  // ALL MUTATIONS AND EFFECTS - MUST BE BEFORE CONDITIONAL RETURNS
  // =====================
  ...
  return (
    <div className="dashboard">
        ...
        <div className="new-project-view">
          ...
          {visibleProjects.length > 0 ? (
            ...
            <div className="new-project-empty">
              <div className="new-project-empty-icon">🤖</div>
              <h2>Dev Squad listo</h2>
              <p>Describe tu proyecto en el campo de abajo para comenzar</p>
            </div>
          )}
          ...
          {historicalProjects.length > 0 && (
            <div className="historical-projects">
              ...
              <p className="historical-projects-hint">
                Proyectos cerrados o eliminados con su snapshot final.
              </p>
      ...
      {/* Unified command bar - always visible at bottom */}
      <CommandBar />
    </div>
  );
}
